...
export default class iOS {
    ...
    static hascamera() {
        // zyx-cover: camera
        // camera = tabletInterfacedeviceName.scratchjr_cameracheck();
        camera = true;
    }
    ...
    static pageError(desc) {
        ...
        if (window.location.href.indexOf('home.html') > -1) {
            ...
            //     console.log('Lobby.errorLoading(desc)');
            // }
            console.log('Lobby.errorLoading(desc)');
        }
    }
