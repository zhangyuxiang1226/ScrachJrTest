...
import SVG2Canvas, { SVGTools_getBoxCenter, SVGTools_getBox } from '../utils/SVG2Canvas';
...
export default class Transform {
    ...
    static updateRotationCenter (elem) {
        ...
        var center = SVGTools_getBoxCenter(elem);
