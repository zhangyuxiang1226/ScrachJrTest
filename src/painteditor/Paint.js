...
export default class Paint {
    ...
    static changeBackground (md5, fcn) {
        ...
        mobj.items = ['*'];
        mobj.values = [saveMD5, ScratchJr_version];
    ...
    */
    ...
    static addToBkgLib (fcn) {
        ...
        function setBkgRecord (pngmd5) {
            ...
            var values = '?,?,?,?,?,?';
            json.values = [saveMD5, pngmd5, ScratchJr_version, '480', '360', 'svg'];
    ...
    */
    ...
    static addToLib (fcn) {
        ...
        function setCostumeRecord (pngmd5) {
            ...
            var values = '?,?,?,?,?,?,?,?';
            json.values = [scale, saveMD5, pngmd5, ScratchJr_version, w, h, 'svg', cname];
